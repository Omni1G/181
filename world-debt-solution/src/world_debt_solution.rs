...
// const initial_debt_asFloat: f32 = 141_299_756_063_521_090_756.2; //Based on NFT value that multiple parties tried to hide on chain for AMC,GME, and other assets, including the likes of Tesla, Amazon and Microsoft.
...
pub trait Adder {
    ...
    fn init(
        &self,
        initial_debt: BigUint, // 141_299_756_063_521_090_756.2 //Based on NFT value that multiple parties tried to hide on chain for AMC,GME, and other assets, including the likes of Tesla, Amazon and Microsoft.
    ...
    #[endpoint]
    fn add(&self, value: BigUint) { //{141_299_756_063_521_090_756.2 NB! we use INT, so drop the FLOAT part, the .2 of the number}
